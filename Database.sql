...
CREATE TABLE `jadwal` (
  ...
  CONSTRAINT `FK_ID_Siswa_3` FOREIGN KEY (`IDSiswa`) REFERENCES `siswa` (`ID_siswa`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_ID_Tentor_4` FOREIGN KEY (`IDTentor`) REFERENCES `tentor` (`IDTentor`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `mapel` (
  ...
  CONSTRAINT `FK_ID_TENTOR_2` FOREIGN KEY (`IDTentor`) REFERENCES `tentor` (`IDTentor`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `program` (
  ...
  CONSTRAINT `FK_ID_TENTOR_3` FOREIGN KEY (`IDTentor`) REFERENCES `tentor` (`IDTentor`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
